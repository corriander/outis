...
APP_VERSION = "0.3.0"  # {x-release-please-version}
...
ARTIFACT_STORE_CONFIG_FILE = os.path.join(DATA_DIR, "artifact_store.json")
ARTIFACT_STORE_CANDIDATE_FILE = os.path.join(DATA_DIR, "artifact_store.pending.json")
PROFILE_SERVICE_CONFIG_FILE = os.path.join(DATA_DIR, "profile_service.json")
PROFILE_SERVICE_CANDIDATE_FILE = os.path.join(DATA_DIR, "profile_service.pending.json")
MANAGED_BOOTSTRAP_FILE = os.path.join(DATA_DIR, "managed_bootstrap.json")
